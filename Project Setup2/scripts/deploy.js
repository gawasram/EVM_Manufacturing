async function main() {
 // Deploy EggToken
const EggToken = await ethers.getContractFactory("contracts/EggToken.sol:BRICKToken");
const eggToken = await EggToken.deploy();
await eggToken.deployed();
console.log("EggToken deployed to:", eggToken.address);

// Deploy EggNFT
const EggNFT = await ethers.getContractFactory("contracts/Eggs.sol:FORGENFT");
